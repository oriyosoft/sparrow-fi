...
function Trends () {
    // const P1 = "../images/products/P1.jpeg";
    return (
        <div class="container my-4">
            ...
            <div id="trendsCarousel" className="carousel slide" data-bs-ride="carousel">
                ...
                <a className="carousel-control-prev" href="#trendsCarousel" role="button" data-bs-slide="prev">
                    <BsChevronCompactLeft aria-hidden="true"></BsChevronCompactLeft>
                    <span className="sr-only">Previous</span>
                </a>
                
                <a className="carousel-control-next" href="#trendsCarousel" role="button" data-bs-slide="next">
